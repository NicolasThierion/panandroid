...
public class Sphere {
    ...
    /**
     * Used in vertex strip calculations, related to properties
     * of a icosahedron.
     */
    ...
    /**
     * Each texture point is made up of 2 points,
     * x, y (in reference to the texture being a 2D image). */
    ...
    public Sphere(final int depth, final float radius) {
        ...
        for (int stripNum = 0; stripNum < this.mTotalNumStrips; stripNum++) {
            ...
            for (int vertexNum = 0; vertexNum < numVerticesPerStrip;
                    vertexNum += 2) {
                // First point - Vertex.
                ...
                // First point - Texture.
                texturePoints[texturePos++] = (float) (1 - azimuth
                        / Maths.THREE_SIXTY_DEGREES);
                texturePoints[texturePos++] = (float) (1 - (altitude
                        + Maths.NINETY_DEGREES) / Maths.ONE_EIGHTY_DEGREES);
            ...
            // Setup texture.
            byteBuffer = ByteBuffer.allocateDirect(numVerticesPerStrip
    ...
    public void loadGLTexture(final GL10 gl, final Context context,
        ...
        /* Use Android GLUtils to specify a two-dimensional texture image from our
           bitmap. */
    ...
    public void draw(final GL10 gl) {
        ...
        for (int i = 0; i < this.mTotalNumStrips; i++) {
            gl.glVertexPointer(AMOUNT_OF_NUMBERS_PER_VERTEX_POINT, GL10.GL_FLOAT,
                    0, this.mVertexBuffer.get(i));
            gl.glTexCoordPointer(AMOUNT_OF_NUMBERS_PER_TEXTURE_POINT, GL10.GL_FLOAT,
                    0, this.mTextureBuffer.get(i));
